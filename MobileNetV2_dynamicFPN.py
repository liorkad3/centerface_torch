...
class MobileNetV2_dynamicFPN(nn.Module):
    def __init__(self, width_mult=1.):
        ...
        self.inverted_residual_setting = [
            ...
            {'expansion_factor': 6, 'width_factor': 24, 'n': 2, 'stride': 2}, #16 -> 24
            {'expansion_factor': 6, 'width_factor': 32, 'n': 3, 'stride': 2}, #24 -> 32  
            {'expansion_factor': 6, 'width_factor': 64, 'n': 4, 'stride': 2}, #32 -> 64
            {'expansion_factor': 6, 'width_factor': 96, 'n': 3, 'stride': 1}, #64 -> 96
            {'expansion_factor': 6, 'width_factor': 160, 'n': 3, 'stride': 2},#64 -> 160
            {'expansion_factor': 6, 'width_factor': 320, 'n': 1, 'stride': 1},#160 -> 320
        ]
